      ...
      <section className="max-w-[1200px] mx-auto px-4 py-20">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 mt-20">
          <div className="md:w-1/2">
            ...
            <p className="text-gray-400 text-base md:text-lg mb-6">
              Speak to the world! Choose your language for UGC video content,
              reaching viewers everywhere.
            </p>
          </div>
          ...
          <div className="md:w-1/2 grid grid-cols-3 gap-2">
            ...
            {Array(6)
              ...
              .map((_, i) => (
                <div
                  key={i}
                  className="bg-gray-800/50 py-3 rounded-lg flex items-center justify-center"
                >
